/*
  ...
  1. Tables
    ...
    - collectors (collector-specific details)
    - requests (pickup requests)
    - availability_windows (time slots for pickups)
    - proposals (collector proposals for requests)
    - disposal_sites (waste disposal locations)
