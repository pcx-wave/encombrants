/*
  # Fix test account creation

  1. Changes
    - Remove manual test account creation from schema
    - Keep table structure and policies intact
    
  2. Notes
    - Test accounts will be created via Supabase Auth API instead
    - This ensures proper password hashing and auth compatibility
*/
